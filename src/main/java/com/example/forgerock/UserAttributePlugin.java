 ...
 * @since AM 5.5.0
 */
public class UserAttributePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(UserAttributePlugin.currentVersion,
				Collections.singletonList(UserAttribute.class));
	}
	...
	public String getPluginVersion() {
		return UserAttributePlugin.currentVersion;
	}
}
